		...
		<div class="container-menu-header">
			<div class="topbar">
				...
				<span class="topbar-child1">
					Free shipping for standard order over 1000 L.E
				</span>
							...
							<ul class="header-cart-wrapitem">
								<li class="header-cart-item">
									<div class="header-cart-item-img">
										<img src="admin/images/<?=$product['img']?>" alt="IMG">
									</div>
					...
					<div class="flex-m flex-w p-b-10">
						...
						<div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
							<select class="selection-2" name="size">
								...
								<option>A3 (11.7 X 16.5)</option>
								<option>A2 (16.5 X 23.4)</option>
							</select>
						</div>
					</div>
		...
		<div class="container">
			...
			<div class="wrap-slick2">
				<div class="slick2">
					<?php
						$cat=$product['cat_id'];
						$related=$conn->query("SELECT * FROM products WHERE cat_id=$cat");
					...
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
								<img src="admin/images/<?=$relPro['img']?>" alt="IMG-PRODUCT">
							...
							<div class="block2-txt p-t-20">
								<a href="product-detail.php?id=<?=$relPro['id']?>" class="block2-name dis-block s-text3 p-b-5">
									<?=$relPro['name']?>
								</a>
