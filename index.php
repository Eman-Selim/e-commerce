	...
	<div class="container1-page">
		...
		<section class="slide1 rs1-slick1">
			<div class="wrap-slick1">
				<div class="slick1">
					<div class="item-slick1 item1-slick1" style="background-image: url(images/master-slide.jpg); ">
				...
				<div class="row">
					<div class="col-sm-10 col-md-8 col-lg-4 m-l-r-auto">
						...
						<div class="block1 hov-img-zoom pos-relative m-b-30">
							<img src="images/master-slide.jpg" alt="IMG-BENNER">
		...
		<!-- Banner2 -->
		<div class="banner2 bg5 p-t-55 p-b-55 bg-img1" style="background-image: url(images/bg-banner-021.jpg);">
			<div class="container">
					...
					<div class="tab-content p-t-35">
						...
						<div class="tab-pane fade show active" id="best-seller" role="tabpanel">
							<div class="row">
								<?php
								require_once 'admin/functions/connect.php';
								$selectPro="SELECT * FROM products WHERE rating=2";
								$query = $conn -> query($selectPro);
								foreach($query as $product){
								?>
						...
						<div class="tab-pane fade" id="featured" role="tabpanel">
							...
							<?php
								require_once 'admin/functions/connect.php';
								$selectPro="SELECT * FROM products WHERE rating=4";
								$query = $conn -> query($selectPro);
								foreach($query as $product){
								?>
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
						...
						<div class="tab-pane fade" id="sale" role="tabpanel">
							...
							<?php
								require_once 'admin/functions/connect.php';
								$selectPro="SELECT * FROM products WHERE rating=3";
								$query = $conn -> query($selectPro);
								foreach($query as $product){
								?>
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
									...
									<div class="block2">
										...
										<div class="block2-txt p-t-20">
											...
											<span class="block2-newprice m-text8 p-r-5">
												<?=$product['price']-$product['sale']?> L.E
											</span>
										</div>
									</div>
								</div>
						...
						<div class="tab-pane fade" id="top-rate" role="tabpanel">
							...
							<?php
								require_once 'admin/functions/connect.php';
								$selectPro="SELECT * FROM products WHERE rating=1";
								$query = $conn -> query($selectPro);
								foreach($query as $product){
								?>
								<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
